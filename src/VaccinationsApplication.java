...
//				If date is invalid then method adjust the day-of-month to the last valid day.}
		...
		System.out.println("\nEpikeimena rantevou gia kathe emvoliastiko kentro: \n");
...
//		}
		...
		System.out.println("\nEleutheres xronikes thirides kathe emvoliastikou kentrou: ");
		...
		System.out.println("\nEmvoliasmoi (hmeromhnia emvoliasmou kai onomatepwnumo asfalimsenou) pou pragmatopoihse kathe giatros, gia olous tous giatrous: ");
		...
		System.out.println("\nAsfalismenoi anw twn 60 etwn pou den exoun kleisei rantevou gia emvoliasmo: \n");
